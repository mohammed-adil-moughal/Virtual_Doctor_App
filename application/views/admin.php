...
<head>
    ...
    <!-- TS1458134582: Neon - Responsive Admin Template created by Laborator -->
</head>

<body class="page-body page-fade" data-url="<?php echo base_url(); ?>">
    <!-- TS14581345824628: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
    <div class="page-container">
        <!-- TS14581345825329: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
        ...
        <div class="main-content">
            <!-- TS145813458214809: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
            <div class="row">
                ...
                <div class="col-md-6 col-sm-8 clearfix">
                    <ul class="user-info pull-left pull-none-xsm">
                        ...
                        <li class="profile-info dropdown">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="http://demo.neontheme.com/assets/images/thumb-1@2x.png" alt="" class="img-circle" width="44" /> Moses Kahunyo
                            </a>
                    ...
                    <ul class="user-info pull-left pull-right-xs pull-none-xsm">
                        ...
                        <li class="notifications dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <!-- TS14581345827034: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
                                <li class="top">
...
last week
                        ...
                        <li class="notifications dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <!-- TS145813458213922: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
                                <li>
...
On so attention necessary at by provision otherwise existence direction.
                        ...
                        <li class="notifications dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <!-- TS14581345827737: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
                                <li class="top">
...
Log Out <i class="entypo-logout right"></i> </a> </li>
            ...
            <hr />
            <!-- TS145813458213026: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-options">
                                <ul class="nav nav-tabs">
                                    <li class=""><a href="#area-chart" data-toggle="tab">Area Chart</a>
                                    </li>
                                    <li class="active"><a href="#line-chart" data-toggle="tab">Line Charts</a>
                                    </li>
                                    <li class=""><a href="#pie-chart" data-toggle="tab">Pie Chart</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <thead>
                                <tr>
                                    <th width="50%" class="col-padding-1">
                                        <div class="pull-left">
                                            <div class="h4 no-margin">Pageviews</div> <small>54,127</small> </div> <span class="pull-right pageviews">4,3,5,4,5,6,5</span> </th>
                                    <th width="50%" class="col-padding-1">
                                        <div class="pull-left">
                                            <div class="h4 no-margin">Unique Visitors</div> <small>25,127</small> </div> <span class="pull-right uniquevisitors">2,3,5,4,3,4,5</span> </th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4>
Real Time Stats
<br /> <small>current server uptime</small> </h4> </div>
                            ...
                            <thead>
                                <tr>
                                    <th class="padding-bottom-none text-center">
                                        <br />
                                        <br /> <span class="monthly-sales"></span> </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="panel-heading">
                                        <h4>Monthly Sales</h4> </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-bordered table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Art Ramadani</td>
                                    <td>CEO</td>
                                    <td class="text-center"><span class="inlinebar">4,3,5,4,5,6</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    ...
                                    <td class="text-center"><span class="inlinebar-2">1,3,4,5,3,5</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3</td>
...
<span>To do list, tick one.</span> </a> </div>
                    ...
                    <div class="tile-group">
                        <div class="tile-left">
                            <div class="tile-entry">
                                <h3>Map</h3> <span>top visitors location</span> </div>
                            <div class="tile-entry"> <img src="http://demo.neontheme.com/assets/images/sample-al.png" alt="" class="pull-right op" />
                                <h4>Albania</h4> <span>25%</span> </div>
                            <div class="tile-entry"> <img src="http://demo.neontheme.com/assets/images/sample-it.png" alt="" class="pull-right op" />
                                <h4>Italy</h4> <span>18%</span> </div>
                            <div class="tile-entry"> <img src="http://demo.neontheme.com/assets/images/sample-au.png" alt="" class="pull-right op" />
                                <h4>Austria</h4> <span>15%</span> </div>
                        </div>
            ...
            <!-- TS145813458216661: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
            <!-- Footer -->
            <footer class="main">
        ...
        <!-- TS145813458218508: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
...
<span class="badge badge-success is-hidden">0</span> </h2>
    ...
    <!-- TS14581345828306: Xenon - Boostrap Admin Template created by Laborator / Please buy this theme and support the updates -->
    ...
    <link rel="stylesheet" href="//demo.neontheme.com/assets/js/jvectormap/jquery-jvectormap-1.2.2.css" id="style-resource-1">
    <link rel="stylesheet" href="//demo.neontheme.com/assets/js/rickshaw/rickshaw.min.css" id="style-resource-2">
    ...
    <script src="http://demo.neontheme.com/assets/js/jvectormap/jquery-jvectormap-1.2.2.min.js" id="script-resource-8"></script>
    <script src="http://demo.neontheme.com/assets/js/jvectormap/jquery-jvectormap-europe-merc-en.js" id="script-resource-9"></script>
    <script src="http://demo.neontheme.com/assets/js/jquery.sparkline.min.js" id="script-resource-10"></script>
    <script src="http://demo.neontheme.com/assets/js/rickshaw/vendor/d3.v3.js" id="script-resource-11"></script>
    <script src="http://demo.neontheme.com/assets/js/rickshaw/rickshaw.min.js" id="script-resource-12"></script>
    <script src="http://demo.neontheme.com/assets/js/raphael-min.js" id="script-resource-13"></script>
    <script src="http://demo.neontheme.com/assets/js/morris.min.js" id="script-resource-14"></script>
    <script src="http://demo.neontheme.com/assets/js/toastr.js" id="script-resource-15"></script>
    <script src="http://demo.neontheme.com/assets/js/neon-chat.js" id="script-resource-16"></script>
    <!-- JavaScripts initializations and stuff -->
    <script src="http://demo.neontheme.com/assets/js/neon-custom.js" id="script-resource-17"></script>
    <!-- Demo Settings -->
    <script src="http://demo.neontheme.com/assets/js/neon-demo.js" id="script-resource-18"></script>
    <script src="http://demo.neontheme.com/assets/js/neon-skins.js" id="script-resource-19"></script>
    <script type="text/javascript">
    /*var _gaq = _gaq || [];
